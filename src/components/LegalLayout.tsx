  ...
  return (
    <div className="min-h-dvh bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        ...
        <article className="prose prose-sm dark:prose-invert mt-8 max-w-none leading-relaxed text-foreground/90 [&_h2]:mt-8 [&_h2]:text-xl [&_h2]:font-semibold [&_h3]:mt-6 [&_h3]:font-semibold [&_p]:mt-3 [&_ul]:ml-6 [&_ul]:mt-3 [&_ul]:list-disc [&_li]:mt-1 [&_a]:tap-link [&_a]:inline-block">
          {children}
        </article>
